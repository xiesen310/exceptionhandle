  ...
  def main(args: Array[String]): Unit = {
    ...
    val partitionSet = message.mapPartitions(itr => {
      ...
      while (itr.hasNext) {
        ...
        val createTime = json1.get("logchecktime").toString.split("T")(0) + json1.get("logchecktime").toString.split("T")(1).substring(0,6)

        val funcId = json2.get("func")
